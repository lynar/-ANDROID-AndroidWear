...
public class MapsActivity extends WearableActivity implements OnMapReadyCallback {
    ...
    ///call of this function when we launch the app
    public void onCreate(Bundle savedState) {
        ...
        setContentView(R.layout.activity_maps); ///set the maps layout
        ...
        //Button He!p action //get the button
        Button help = findViewById(R.id.callhelp);
        //set what happen when we push the button
    ...
    public void openActivityWarRoom(){
        Intent intent = new Intent(this, WarRoom2.class);
